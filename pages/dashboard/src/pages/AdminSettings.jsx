...
const TEST_SECTIONS = [
    {
        ...
        icon: Headphones,
        color: '#8b5cf6',
        addUrl: '/settings/admin/tests/add/listening/',
    ...
    },
    {
        ...
        icon: BookOpen,
        color: '#3b82f6',
        addUrl: '/settings/admin/tests/add/reading/',
    ...
    },
    {
        ...
        icon: PenTool,
        color: '#10b981',
        addUrl: '/settings/admin/tests/add/writing/',
    ...
    },
    {
        ...
        icon: Layers,
        color: '#f59e0b',
        addUrl: '/settings/admin/tests/add/fullMock/',
        ...
        <div className="admin-page page-enter">
            ...
            <section className="admin-section">
                ...
                <div className="management-list">
                    ...
                    <Link to="/admin/results" className="management-item glass-card">
                        <div className="management-icon" style={{ background: 'rgba(139, 92, 246, 0.08)', color: '#8b5cf6' }}>
